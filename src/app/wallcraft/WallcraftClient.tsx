          ...
          <div className={`max-w-3xl transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button
                ...
                className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white rounded-xl text-sm font-semibold shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {borisGenerating ? (
                  <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-6">
            ...
            <div
              onClick={borisGenerating ? undefined : handleBorisGenerate}
              className={`group cursor-pointer bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden border border-gray-700/40 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 relative ${borisGenerating ? 'pointer-events-none' : ''}`}
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-purple-500/15 via-transparent to-transparent rounded-full blur-2xl" />
              <div className="aspect-[16/9] flex items-center justify-center relative overflow-hidden">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-fuchsia-600 flex items-center justify-center text-white shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform duration-300">
                  {borisGenerating ? (
            ...
            {/* Design Studio */}
            <div onClick={() => router.push('/wallcraft/studio')} className="group cursor-pointer bg-white rounded-2xl overflow-hidden border border-gray-200/60 hover:shadow-xl transition-all duration-300">
